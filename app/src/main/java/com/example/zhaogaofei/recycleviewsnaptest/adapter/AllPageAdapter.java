...
public class AllPageAdapter extends RecyclerView.Adapter<AllPageAdapter.LinearSnapHolder> {
    private Context mContext;
    private List<String> mList;

    public AllPageAdapter(Context context, List<String> list) {
        mContext = context;
        if (mList == null) {
            mList = new ArrayList<>();
        }
    ...
    public LinearSnapHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_all_page, viewGroup, false);
    ...
    static class LinearSnapHolder extends RecyclerView.ViewHolder {
        ...
        public LinearSnapHolder(@NonNull View itemView) {
            super(itemView);
            textView = itemView.findViewById(R.id.tv_item_all_page);
        }
    }
}
